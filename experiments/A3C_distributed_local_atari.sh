...
SLURM_JOB_CPUS_PER_NODE=10 CUDA_VISIBLE_DEVICES='' python3 deeprl/rlmethods/a3c_distributed.py --job_name ps \
...
do
    ...
    SLURM_JOB_CPUS_PER_NODE=10 CUDA_VISIBLE_DEVICES='' python3 deeprl/rlmethods/a3c_distributed.py --env Breakout-v0 \
